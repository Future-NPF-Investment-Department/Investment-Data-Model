...
namespace InvestmentDataModel
{
    ...
    {
        public SourceFile() { }
        private SourceFile(FileInfo file, string provider, ReportPricingType pricing, SqlTargetTable destination)
        {
        ...
        /// </remarks>
        public virtual ICollection<NetAssetValue> AssetRecords { get; set; } = null!;
        ...
        ///     Reflects one-to-many relationship (navigation property) with on-delete-cascade constraint.
        /// </remarks>
        public virtual ICollection<Flow> FlowsRecords { get; set; } = null!;

        public static SourceFile New(FileInfo file, string fileProvifer, ReportPricingType pricing, SqlTargetTable destination)
        {
            if (file.Directory is null) throw new Exception("");
            return new SourceFile(file, fileProvifer, pricing, destination);
        }
